                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="post" action="{{ route('sales.customers.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="phone" name="phone" type="tel" class="mt-1 block w-full" required autocomplete="phone" />
                        ...
                        <div>
                            ...
                            <x-text-input id="tax_number" name="tax_number" type="text" class="mt-1 block w-full" required autofocus autocomplete="tax_number" />
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" autofocus autocomplete="address"></textarea>
                        </div>
                        ...
                        <div class="flex gap-6">
                            ...
                            <x-text-input id="postal" name="postal" type="text" class="mt-1 block w-full" autofocus autocomplete="postal" />
                            </div>
